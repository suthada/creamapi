...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel,MainAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
        ...
        holder.sex.setText(model.getDate());
        holder.age.setText(model.getType());
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText sex = view.findViewById(R.id.txtdate);
                EditText age = view.findViewById(R.id.txttype);
                EditText purl = view.findViewById(R.id.txtImageUrl);

                Button btnUpdate = view.findViewById(R.id.btnUpdate);

                name.setText(model.getName());
                sex.setText(model.getDate());
                age.setText(model.getType());
                purl.setText(model.getLurl());
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("datausers")
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            sex = (TextView)itemView.findViewById(R.id.datetext);
            age = (TextView)itemView.findViewById(R.id.typetext);
