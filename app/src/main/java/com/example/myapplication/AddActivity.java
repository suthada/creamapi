...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sex = (EditText)findViewById(R.id.txtdate);
        age = (EditText)findViewById(R.id.txttype);
    ...
    private void insertData(){
        ...
        FirebaseDatabase.getInstance().getReference().child("datausers").push()
                .setValue(map)
